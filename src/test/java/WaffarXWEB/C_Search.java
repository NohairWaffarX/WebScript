...
public class C_Search
{
    ...
    {
        Login() ;
        retryType(Search_text, "dfjkjdfkdjk", 40);
    ...
    {
        Login() ;
        retryType(Search_text, "amazon", 40);
        retryClick(Search_Button, 40);
    ...
    {
        Login();
        retryType(Search_text, "the hut", 40);
        retryClick(Search_Button, 40);
